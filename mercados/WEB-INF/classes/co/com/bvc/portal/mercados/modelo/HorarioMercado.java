...
public class HorarioMercado implements IEntidadPortal, Comparable {
	...
	/** The hora inicio. */
	private GregorianCalendar horaInicio = new GregorianCalendar();

	/** The hora fin. */
	private GregorianCalendar horaFin = new GregorianCalendar();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof HorarioMercado)) {
			return false;
		}

		return ((HorarioMercado) obj).getIdHor().equals(this.idHor);
	}
	...
	public int compareTo(Object obj) {
		...
		return ((Integer)((HorarioMercado) obj).getIdHor())-(this.idHor);
