...
/**
 * The Class AccionesTTVDaoSpringJdbc.
 */
public class AccionesTTVDaoSpringJdbc extends JDBCDaoImp implements IAccionesTTVDao {
	...
	public List<ResumenBoceas> cargarMasTranzadasExcel(String fecha)
			throws PersistenciaException {
		...
		if (fecha == null || "".equals(fecha.trim())) {
			...
			log.info("Fecha Gregorian: "+fecha);
	...
	public List<ResumenAccion> cargarMasTranzadasDiaUltDia() throws Exception {
		...
		//String fecha20Min=UtilFechas.getHoy("yyyy-MM-dd");
		List<Map> resQuery = cargarPorNombreQuery(
				IConstantesConsultasAcciones.LISTA_TTV_HOY,
				new String[] { IConstantesConsultasAcciones.FECHA_FIN },
	...
	public List<OperacionDiaAcciones> operacionesUltimoDia(String nemo)
		...
		String consulta = "SELECT "
			...
			+ "	ttvs.v_rftr_tasa tasa, "
			+ "	cumope.v_cumope_fec_cump hora, "
			+ "	ttvs.v_rftr_valcap + + ttvs.v_rftr_monto montoRecompra, "
	...
	public List<OperacionDiaAcciones> operaciones(String nemo, String fecha)
		...
		String consulta = "SELECT "
			...
			+ "	ttvs.v_rftra_tasa tasa, "
			+ "	cumope.v_cumope_fec_cump hora, "
			+ "	ttvs.v_rftra_valcap + + ttvs.v_rftra_monto montoRecompra, "
