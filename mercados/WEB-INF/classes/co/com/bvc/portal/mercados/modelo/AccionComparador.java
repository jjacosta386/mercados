 ...
 */
public class AccionComparador implements Comparator<ResumenAccion> {
	 ...
	 */
	public AccionComparador (int compararPor){
	 ...
	 */
	public int compare(ResumenAccion o1, ResumenAccion o2) {
		if(comparar == VOLUMEN){
