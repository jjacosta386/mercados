            ...
            <div class="acordeon_interior_contenido" id="seg_acc_1"
                ...
                <div class="acordeon_titulo_contenedor_resumen">
                    <table cellpadding="0" cellspacing="0" class="tabla_basica"
                           id="texto_24" style="overflow: auto">
                        <caption id="texto_30">Ultima Marcaci&oacute;n: 
                            <c:out value="${horaTransaccion}"/>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th>Precio Medio</th>
                                <th>Precio Menor</th>
                                <th width="80">Variaci&oacute;n %</th>
                                <th>Variación Absoluta</th>
                            </tr>
                            <tr>
                                <th class="specblue" style="padding-left:3px; padding-right:3px;">
                                    <c:choose>
                                        <c:when test="${horaTransaccion eq null}">
                                            sin valor
                                        </c:when>
                                        <c:otherwise>
                                            <c:out value="${horaTransaccion}" />
