...
<br/> 
 <div class="titulo_seccion_unacolumna" id="text_12">Titulo <c:out value="${tituloRF.tipoTitulo}"/>
  ...
  <div id="nota_titulo">
    <h3>&nbsp;</h3>
    <h2>Informaci&oacute;n con <c:out value="${retraso}" /> minutos de retraso</h2></div>
    <br clear="all" />
...
<div id="text_ver_seg_2" class="ver_detalles_bvc" onclick="
    ...
    <div id="seg_acc_2" class="acordeon_interior_contenido">
      ...
      <div class="acciones_encabezado_tabla">
              <table cellpadding="0" cellspacing="0" class="tabla_basica" id="text_20" style="table-layout:fixed; width:100%">
          <!--caption>
            Ultima operaci&oacute;n: 2008-07-31  12:58 p.m.
          </caption-->
          <tr>
		  <th width="45" class="renta_detalle_titulo">HORA</th>
            <th width="50" class="renta_detalle_titulo">PRECIO SUCIO</th>
            <th width="42" class="renta_detalle_titulo">TASA</th>
    <th width="70" class="renta_detalle_titulo">CANTIDAD</th>
    <th width="80" class="renta_detalle_titulo">VOLUMEN</th>
    <th width="74" class="renta_detalle_titulo">TIPO</th>
    <th width="40" class="renta_detalle_titulo">TIPO PLAZO</th>
    <th width="45" class="renta_detalle_titulo">TASA CUPON</th>
    <th width="40" class="renta_detalle_titulo">MOD. PAGO</th>
    <th width="65" class="renta_detalle_titulo">EMISION</th>
    <th width="78" class="renta_detalle_titulo">VENCIMIENTO</th>
    <th width="46" class="renta_detalle_titulo">SESIÓN</th>
    <th width="59" class="renta_detalle_titulo">MERCADO</th>
  </tr>
            </table>
      </div>
                  <div class="mercado_acciones_scroll">
      <div class="mercado_acciones_scroll_interior">
        <table width="748" cellpadding="0" cellspacing="0" class="tabla_basica" id="text_23" style="table-layout:fixed; width:100%">
  <c:forEach items="${operacionesRF}" var="operacion">
  <tr>
	<td width="45" class="celda_tabla_basica">
		<c:choose>
			<c:when test="${operacion.fechaOperacion eq null}">
				<c:out value=""/>
			</c:when>
			<c:otherwise>
				<fmt:formatDate value="${operacion.fechaOperacion}" pattern="hh:MM:ss" />
			</c:otherwise>
		</c:choose>
	</td>
    <td width="50" class="celda_tabla_basica"><fmt:formatNumber pattern="###.###" ><c:out value="${operacion.precioSucio}"/></fmt:formatNumber></td>
    <td width="42" class="celda_tabla_basica"><c:out value="${operacion.tasa}"/></td>
    <td width="70" class="celda_tabla_basica"><fmt:formatNumber pattern="###,###.##" ><c:out value="${operacion.cantidad}"/></fmt:formatNumber></td>
    <td width="80" class="celda_tabla_basica"><fmt:formatNumber pattern="###,###.##" ><c:out value="${operacion.volumen}"/></fmt:formatNumber></td>
    ...
    <td width="40" class="celda_tabla_basica"><c:out value="${operacion.tipoPlazo}"/></td>
    <td width="45" class="celda_tabla_basica"><c:out value="${operacion.tasaCupon}"/></td>
    <td width="40" class="celda_tabla_basica"><c:out value="${operacion.modalidadPago}"/></td>
    <td width="65" class="celda_tabla_basica"><c:out value="${operacion.fechaEmisionFormat}"/></td>
    <td width="78" class="celda_tabla_basica"><c:out value="${operacion.fechaVencimientoFormat}"/></td>
    <td width="46" class="celda_tabla_basica"><c:out value="${operacion.sesionNegociacion}"/></td>
    <td width="59" class="celda_tabla_basica"><c:out value="${operacion.mercado}"/></td>
  </tr>
  </c:forEach>
</table>
        </div>
