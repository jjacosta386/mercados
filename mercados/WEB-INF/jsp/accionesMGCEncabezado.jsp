		...
		<form id="formulario" name="busqueda" action="<%=formAction%>" method="post">
		  ...
		  <table cellpadding="0" cellspacing="0" border="0" style="font-family:Arial">
			  <tr>
				  ...
				  <td style="padding:4px 0px">
						<select name="tipoMercado" size="1" class="operacion" id="tipoMercado" width="153px" style="width: 153px; float:right; margin-right:10px">
							<option value="4" 
								<c:if test="${formulario.tipoMercado == '4'}">selected="selected"</c:if>>
								Compraventas
							</option>
							<option value="6"
								<c:if test="${formulario.tipoMercado == '6'}">selected="selected"</c:if>>
								Repos
							</option>
							<option value="7"
								<c:if test="${formulario.tipoMercado == '7'}">selected="selected"</c:if>>
								TTV
							</option>
						</select>				  
				  </td>
				  <td class="fechaneg" style="padding:4px 0px">
				  <ul class="mercados">
				  <li class="fechaneg" style="width:auto;padding:0px">
						<label style="width: auto;">
							<span id="texto_12">Fecha de negociación:</span>
						 </label>	
</li>
</ul>						 
				  </td>
				  ...
				  <td style="padding:4px 0px">
                     <label style="width: auto;">
                         <span class="fechalista" style="padding-left:10px">
                                <select name="anioFecha" size="1" id="anioFecha" style="width: 70px">
			  ...
			  <tr>
				  ...
				  <ul class="mercados">
				  <li style="width:auto;padding:0px">
              				<label><span id="text_3">Tipo de Instrumento:</span>
				  ...
				  <td style="padding:4px 0px">
                     <label style="width: auto;">
                         <span class="fechalista" style="padding-left:10px">
                                <select name="tipoInstrumento" size="1" class="operacion" id="tipoInstru" width="153px" style="width: 153px; float:right; margin-right:10px">
                                <option value="0" <c:if test="${formulario.tipoInstrumento == '0'}">selected="selected"</c:if>>
						Todos</option>
									<option value="4" 
								<c:if test="${formulario.tipoInstrumento == '4'}">selected="selected"</c:if>>
								Acciones
							</option>
							<option value="5"
								<c:if test="${formulario.tipoInstrumento == '5'}">selected="selected"</c:if>>
								ETFs
							</option>
				  ...
				  <td style="padding-bottom:4px;padding-left:0px;padding-right:0px;padding-top:0;">
				  <ul class="mercados">
				  <li class="fechaneg" style="width:auto;padding:0px">
				  <label>
				  ...
				  <td colspan="3" style="padding-bottom:4px;padding-left:0px;padding-right:0px;padding-top:0;">
				  <c:if test="${resumen}">
						<c:if test="${tipoMercado==null || tipoMercado == 4}">
							<label>
								
						<%try{%>
<select style="margin-left:0px; width:170px" class="operacion" size="1" onChange="cambiarAcciones();" id="filtroAcciones" width="170px" >
...
<%}%>
			  ...
			  <td style="padding-bottom:4px;padding-left:0px;padding-right:0px;padding-top:0;">
				  ...
				  <td>
				<input width="150px" style="float:right; margin-right:10px; width:150px" name="nemo" type="text" id="nemo" value="<c:out value='${formulario.nemo}'/>"/>				  
				  </td>
				  <td style="padding-bottom:4px;padding-left:0px;padding-right:0px;padding-top:0;">
				  <ul class="mercados">
				  </ul>
				...
				<td style="padding-bottom:4px;padding-left:0px;padding-right:0px;padding-top:0;">
				  ...
				  <td style="padding-bottom:4px;padding-right:0px;padding-top:0;padding-left:150px">
					<div id="contenedor_buscador" style="float:right">
						<div class="boton_regular" style="float:right"><a href="javascript:document.busqueda.submit();">Buscar</a></div>
					</div>				  
				  </td>
