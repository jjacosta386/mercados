              		...
              		<li style="position:relative">
						<label><span id="text_10">Sesión de negociación :</span>
							<select name="tipoSesion" size="1" class="operacion" id="renta_detalle2">
								...
								<option <c:if test="${RentaFijaBusqueda.tipoSesion eq 'SCRC'}">selected="selected"</c:if> value="SCRC">SCRC</option>
...
<div id="nota_titulo">
	<h3>&nbsp;</h3>
    <h2>Informaci&oacute;n con <c:out value="${retraso}" /> minutos de retraso</h2>
</div>
<br clear="all" />
