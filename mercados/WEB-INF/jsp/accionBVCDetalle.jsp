...
<script type='text/javascript' src='/mercados/dwr/interface/accionesAjax.js'></script>
...
(       
        ...
        function( ) 
	{
		accionesAjax.getNemotecnicos( getAnswer );
	}
);
...
<form id="formhistorico" action="/mercados/DescargaXlsServlet"
	...
	name="archivo" value="acciones_detalle" /> <input type="hidden"
