...
<div id="tab_contenedor_mercados">
	...
	<div class="derivados_detalle_tabla_contenedor">
		<div class="derivados_detalle_tabla">
			...
			<div class="derivados_detalle_tabla" id="tabla_derivados_superior">
									...
									<tr>
										...
										<th class="futurderivado" width="40%" align="center">
											<div id='cerrar_public<c:out value="${status.count}"  /><c:out value="${st.count}"  />' class="renta_btn_cerrar"
												onclick="MM_changeProp('deuda_public<c:out value="${status.count}"  /><c:out value="${st.count }"/>','','display','none','DIV');MM_changeProp('cerrar_public<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','none','DIV');MM_changeProp('ver_public<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','block','DIV');
		                   						mostrar_campo_interno_inactivo('futur_<c:out value="${status.count}"  /><c:out value="${st.count}"  />'); ">Cerrar
											...
											<div id='ver_public<c:out value="${status.count}"  /><c:out value="${st.count}"  />' class="renta_btn"
												onclick="MM_changeProp('deuda_public<c:out value="${status.count}"  /><c:out value="${st.count }"/>','','display','block','DIV');MM_changeProp('ver_public<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','none','DIV');MM_changeProp('cerrar_public<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','block','DIV'); 
		...
		<div class="contenedor_boton_imprimir">
			<table width="100%" border="0" cellspacing="0" cellpadding="10">
				<tr>
					<td width="45%">&nbsp;</td>
					<td width="10%">&nbsp;</td>
					<td width="45%" align="right"><a id="texto_1" href='/mercados/DescargaXlsServlet?archivo=derivados&anio=<c:out value="${busquedaDerivados.anioFecha}"/>&mes=<c:out value="${busquedaDerivados.mesFecha}"/>&dia=<c:out value="${busquedaDerivados.diaFecha}"/>' class="excelneg">Descargar
									...
									<tr>
										...
										<td width="20%" align="center">
											<div id='cerrar_public2<c:out value="${status.count}"  /><c:out value="${st.count}"  />' class="renta_btn_cerrar"
												onclick="MM_changeProp('deuda_public2<c:out value="${status.count}"  /><c:out value="${st.count }"/>','','display','none','DIV');MM_changeProp('cerrar_public2<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','none','DIV');MM_changeProp('ver_public2<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','block','DIV');
		                   						mostrar_campo_interno_inactivo('futur_2<c:out value="${status.count}"  /><c:out value="${st.count}"  />'); ">Cerrar
												<img src="%%SiteContent.Portlet('common.bvc.recursos')%%/images/ico_cerrar.gif" alt="Cerrar" border="0" />
											</div>
											<div id='ver_public2<c:out value="${status.count}"  /><c:out value="${st.count}"  />' class="renta_btn"
												onclick="MM_changeProp('deuda_public2<c:out value="${status.count}"  /><c:out value="${st.count }"/>','','display','block','DIV');MM_changeProp('ver_public2<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','none','DIV');MM_changeProp('cerrar_public2<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','block','DIV'); 
									...
									<tr>
										...
										<td width="120" align="center">
											<div id='cerrar_public3<c:out value="${status.count}"  /><c:out value="${st.count}"  />' class="renta_btn_cerrar"
												onclick="MM_changeProp('deuda_public3<c:out value="${status.count}"  /><c:out value="${st.count }"/>','','display','none','DIV');MM_changeProp('cerrar_public3<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','none','DIV');MM_changeProp('ver_public3<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','block','DIV');
		                   						mostrar_campo_interno_inactivo('futur_3<c:out value="${status.count}"  /><c:out value="${st.count}"  />'); ">Cerrar
												<img src="%%SiteContent.Portlet('common.bvc.recursos')%%/images/ico_cerrar.gif" alt="Cerrar" border="0" />
											</div>
											<div id='ver_public3<c:out value="${status.count}"  /><c:out value="${st.count}"  />' class="renta_btn"
												onclick="MM_changeProp('deuda_public3<c:out value="${status.count}"  /><c:out value="${st.count }"/>','','display','block','DIV');MM_changeProp('ver_public3<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','none','DIV');MM_changeProp('cerrar_public3<c:out value="${status.count}"  /><c:out value="${st.count}"  />','','display','block','DIV'); 
