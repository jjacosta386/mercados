...
<c:if test="${empty nemoTecnico}">
    ...
    <div id="nota_titulo">
        <h3>&nbsp;</h3>
        <h2 id="texto_9">Informaci&oacute;n con <c:out value="15"></c:out> minutos de retraso</h2>
        </div>
        <br clear="all" />
        <div align= "center">
            <h3>&nbsp;</h3>
...
<c:if test="${not empty nemoTecnico}">
    ...
    accionGraficoDia
            .addVariable(
                    "settings_file",
                    escape("/mercados/GraficosServlet?conf=<c:out value='${titulo.nemotecnico}'/>&url=/amstock/settings/acciones_hoy_stock_settings.xml&tipoG=ACCIONMGC&tiempo=hoy"));
                    ...
                    <script
                        type="text/javascript">
                                            ...
                                            accionGraficoHist
                                                    .addVariable(
                                                            "settings_file",
                                                            escape("/mercados/GraficosServlet?conf=<c:out value='${titulo.nemotecnico}'/>&url=/amstock/settings/acciones_stock_settings.xml&tipoG=ACCIONMGC&tiempo=ayer"));
...
<div class="contenedor_acordeon_borde">
    <div class="contenedor_acordeon_sin_borde">
        <div id="acordeon_contenedor">
            ...
            <div class="acordeon_interior_contenido" id="seg_acc_1"
                ...
                <div class="acordeon_titulo_contenedor_resumen">
                    ...
                    <div class="menu_tabla">
                        <%@ include file="/WEB-INF/jsp/accionesMGCDetalleDescarga.jsp"%>
                    </div>
                </div>
            </div>
            <c:choose>
                <c:when test="${tipoMercado==null || tipoMercado == 4}">
                    <%@ include file="/WEB-INF/jsp/accionesMGCDetalleCV.jsp"%>
                </c:when>
                <c:when test="${tipoMercado == 2}">
                    <%@ include file="/WEB-INF/jsp/accionesMGCDetalleRepos.jsp"%>
                </c:when>
                <c:otherwise>
            ...
            <div class="acordeon_titulo_interior">
                <div class="acordeon_titulo_segmento">
                    <p id="texto_28">Mercado Global - Caracter&iacute;sticas de la Acci&oacute;n</p>
                    ...
                    <div id="text_cerrar_seg_3" class="cerrar_detalle_bvc"
                         onclick="manejarAcordeon(3, 'cerrar');
                " style="display: none;">
                        cerrar</div>
                </div>
            </div>
                ...
                <div class="acordeon_titulo_contenedor_resumen">
                    <table id="texto_31" width="100%" border="0" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <td class="detalles_accionista_td1">Modalidad:</td>
                        ...
                        <td class="detalles_accionista_td1">CUSIP</td>
                        <td class="detalles_accionista_td2"><c:out value="${titulo.cusip}" /></td>
                        </tr>
                        <tr>
                            <td class="detalles_accionista_td1">Pais de Origen</td>
                            <td class="detalles_accionista_td2"><c:out value="${titulo.paisOrigen}" /></td>
                            <td class="detalles_accionista_td1">Cotizaci&oacute;n Principal Inicial</td>
                            <td class="detalles_accionista_td2"><c:out value="${titulo.cotizacionPrincipal}" /></td>
                        </tr>
                        <tr>
                            <td class="detalles_accionista_td1">Patrocinador</td>
                            <td class="detalles_accionista_td2"><c:out value="${titulo.patrocinador}" /></td>
                            <td class="detalles_accionista_td1">Otras Bolsas</td>
                            <td class="detalles_accionista_td2"><c:out value="${titulo.otrasBolsas}" /></td>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="acordeon_titulo_interior">
                <div class="acordeon_titulo_segmento">
                    <p id="texto_29">Mercado Global - Informaci&oacute;n del Emisor</p>
                    ...
                    <table id="texto_32" width="100%" border="0" cellspacing="0"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="detalles_accionista_td2">
                                    <a href="/pps/tibco/portalbvc/Home/Mercado+Global/Listado+Emisores?com.tibco.ps.pagesvc.action=portletAction&action=link&MGC=true&emisorId=<c:out value="${titulo.idEmisor}"/>">
                                        <c:out value="${titulo.emisor.razonSocial}" />
                                    </a>
                                </td>
                            ...
                            <tr>
                                <td class="detalles_accionista_td4" align="center">PAIS</td>
                                <td class="detalles_accionista_td2"><c:out
                                        value="${titulo.paisOrigen}" /></td>
                                <td class=" detalles_accionista_td4" align="center"></td>
