							...
							<div id="texto_grafica_dia" style="height: 100%">
								<script type="text/javascript">
									...
									derivadoGraficoDia
											.addVariable(
													"settings_file",
													escape('/mercados/GraficosServlet?conf=<c:out value="${nemo}"/>&url=/amstock/settings/derivados_hoy_stock_settings.xml&tipoG=DERIVADOS&tiempo=hoy&opcf=<c:out value="${opcf}"/>'));
							...
							<div id="texto_grafica_hist" style="height: 100%">
								<script
									...
									derivadoGraficoHist
											.addVariable(
													"settings_file",
													escape('/mercados/GraficosServlet?conf=<c:out value="${nemo}"/>&url=/amstock/settings/derivados_stock_settings.xml&tipoG=DERIVADOS&tiempo=ayer&opcf=<c:out value="${opcf}"/>'));
      				...
      				<div class="acordeon_titulo_contenedor_resumen">
        				...
        				<div class="menu_tabla">
							<form id="formhistorico" action="/mercados/DescargaXlsServlet"
								...
								<input type="hidden" name="archivo" value="derivados_detalle" /> 
